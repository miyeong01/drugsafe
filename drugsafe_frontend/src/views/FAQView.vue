    ...
    items: [
      {
        ...
        answer: 'DrugSafe는 안전하고 정확한 의약품 정보를 제공하는 서비스입니다. 증상에 맞는 의약품을 검색하고, 다른 사용자들의 리뷰를 확인하며, 복용 중인 약을 관리할 수 있습니다.',
      },
      {
        id: 'service-2',
        question: '회원가입은 어떻게 하나요?',
        answer: '상단 메뉴의 "로그인" 버튼을 클릭한 후, "회원가입" 탭을 선택하여 필요한 정보를 입력하시면 됩니다. 이메일 인증을 완료하면 바로 서비스를 이용하실 수 있습니다.',
      },
      {
        id: 'service-3',
        question: '서비스 이용 요금이 있나요?',
        answer: 'DrugSafe의 모든 기본 서비스는 무료로 제공됩니다. 의약품 검색, 리뷰 작성 및 확인, 복용 관리 등 모든 기능을 무료로 이용하실 수 있습니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: '의약품 상세 페이지에서 "복용 추가" 버튼을 클릭하여 복용 기간과 횟수를 설정하실 수 있습니다.',
      },
      {
        id: 'medication-2',
        question: '복용 알림 기능이 있나요?',
        answer: '현재는 웹에서 수동으로 복용 체크를 하는 기능만 제공되고 있습니다.',
      },
      {
        id: 'medication-3',
        question: '복용 기록은 얼마나 보관되나요?',
        answer: '복용 기록은 별도로 삭제하지 않는 한 계속 보관됩니다.',
      },
    ],
  },
]
