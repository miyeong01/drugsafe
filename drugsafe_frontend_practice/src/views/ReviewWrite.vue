    ...
    <div class="container" style="max-width: 800px">
      <div class="mb-4">
        ...
        <p class="text-secondary mt-2" v-if="selectedDrug">
          <span class="text-primary fw-bold">{{ selectedDrug.name }}</span
          >에 대한 리뷰를 작성해주세요
        </p>
        <p class="text-secondary mt-2" v-else>약 정보를 불러오는 중입니다...</p>
      </div>
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body p-4 p-md-5">
          <div class="d-flex flex-column gap-4">
            ...
            <div>
              <label class="form-label fw-bold mb-2">효과</label>
            ...
            <div class="row g-3 pt-3">
              ...
              <div class="col-6">
                <button
                  type="button"
                  @click="handleSubmit"
                  class="btn btn-primary w-100 py-2 fw-bold text-white"
                >
                  리뷰 등록
                </button>
              </div>
